...
if( $('[data-copy-to-clipboard]').length ) {
	theme.fn.intObs( '[data-copy-to-clipboard]', function(){
		...
		var $copyButton = $('<a href="javascript:void(0)" class="btn btn-primary btn-px-2 py-1 text-0 position-absolute top-8 right-8">COPY</a>');
	...
	$.extend(theme, {
		...
		Nav: {
			...
			events: function() {
				...
				$header.find('a[href="javascript:void(0)"]').on('click', function(e) {
					e.preventDefault();
				});
				...
				$header.find('.dropdown-toggle[href="javascript:void(0)"], .dropdown-submenu a[href="javascript:void(0)"], .dropdown-toggle[href!="#"] .fa-chevron-down, .dropdown-submenu a[href!="#"] .fa-chevron-down').on('click', function(e) {
					e.preventDefault();
					if ($window.width() < 992) {
				...
				// Add Open Class
				$header.find('.header-nav-click-to-open .dropdown-toggle[href="javascript:void(0)"], .header-nav-click-to-open .dropdown-submenu a[href="javascript:void(0)"], .header-nav-click-to-open .dropdown-toggle > i').on('click', function(e) {
